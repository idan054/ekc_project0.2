...
class _LoginPageState extends State<LoginPage> {
  ...
  Future _login({required bool classicLogin}) async {
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  keyboardType: TextInputType.emailAddress,
                  obscureText: true,
                  onEditingComplete: () =>  _login(classicLogin: true),
                  textCapitalization: TextCapitalization.none,
                  textInputAction: TextInputAction.done,
                ),
              ),
              TextButton(
                onPressed: _loggingIn ? null : () =>  _login(classicLogin: true),
              ...
              ElevatedButton(
                  ...
                  onPressed: () async {
                         await _login(classicLogin: false); // Google
/*                    setState(() async {
